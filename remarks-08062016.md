...
- de placeholder voor de taal wordt niet uitgevoerd in HTML comments: < !--[if lt IE 7 ]> <html class="ie ie6 {LANG}"> <![endif]-->
- definieren van de taal op de HTML tag <html lang='nl'>
